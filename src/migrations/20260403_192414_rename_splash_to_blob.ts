...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "pages_blocks_our_process_steps" (
  ...
  CREATE TABLE "pages_blocks_our_process" (
  	"_order" integer NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_our_process_steps" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  ...
  CREATE TABLE "_pages_v_blocks_our_process" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  ...
  CREATE INDEX "pages_blocks_our_process_steps_order_idx" ON "pages_blocks_our_process_steps" USING btree ("_order");
  CREATE INDEX "pages_blocks_our_process_steps_parent_id_idx" ON "pages_blocks_our_process_steps" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_our_process_steps_image_idx" ON "pages_blocks_our_process_steps" USING btree ("image_id");
  CREATE INDEX "pages_blocks_our_process_order_idx" ON "pages_blocks_our_process" USING btree ("_order");
  CREATE INDEX "pages_blocks_our_process_parent_id_idx" ON "pages_blocks_our_process" USING btree ("_parent_id");
  CREATE INDEX "pages_blocks_our_process_path_idx" ON "pages_blocks_our_process" USING btree ("_path");
  CREATE INDEX "_pages_v_blocks_our_process_steps_order_idx" ON "_pages_v_blocks_our_process_steps" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_our_process_steps_parent_id_idx" ON "_pages_v_blocks_our_process_steps" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_our_process_steps_image_idx" ON "_pages_v_blocks_our_process_steps" USING btree ("image_id");
  CREATE INDEX "_pages_v_blocks_our_process_order_idx" ON "_pages_v_blocks_our_process" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_our_process_parent_id_idx" ON "_pages_v_blocks_our_process" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_our_process_path_idx" ON "_pages_v_blocks_our_process" USING btree ("_path");`)
}
